            ...
            <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
              ...
              <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
                ...
                <button 
                  ...
                  title="Share Product on Social Media"
                >
        ...
        >
          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                <div style={{ background: 'rgba(255, 85, 0, 0.15)', padding: '10px', borderRadius: '14px', color: '#FF5500', display: 'flex', flexShrink: 0 }}>
                  <Share2 size={22} />
                </div>
                <div>
            ...
            <div style={{
              ...
              <img 
                src={selectedImage || product.img} 
                alt={product.title} 
                style={{ width: '50px', height: '50px', objectFit: 'contain', borderRadius: '10px', background: '#fff', padding: '4px', flexShrink: 0 }}
              />
              <div style={{ flex: 1, minWidth: 0 }}>
                <h4 style={{ margin: '0 0 4px 0', fontSize: '0.85rem', fontWeight: 700, color: 'var(--text-primary)', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                  {product.title}
                </h4>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  <span style={{ fontWeight: 800, fontSize: '0.88rem', color: '#FF5500' }}>
                    ₹{product.price?.toLocaleString('en-IN')}
                  </span>
                  {product.discount && (
                    <span style={{ fontSize: '0.7rem', background: 'rgba(255,85,0,0.12)', color: '#FF5500', fontWeight: 700, padding: '2px 6px', borderRadius: '6px' }}>
                      {product.discount}
                    </span>
                  )}
                </div>
            ...
            {/* Social Channels Row */}
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: '4px', textAlign: 'center', width: '100%', boxSizing: 'border-box', alignItems: 'start' }}>
              {/* WhatsApp */}
              <button 
                onClick={handleShareWhatsApp}
                style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '6px', background: 'transparent', border: 'none', cursor: 'pointer', width: '100%', minWidth: 0, padding: '2px 0', boxSizing: 'border-box' }}
              >
                <div style={{ width: 'clamp(36px, 10vw, 42px)', height: 'clamp(36px, 10vw, 42px)', borderRadius: '14px', background: '#25D366', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', boxShadow: '0 4px 12px rgba(37, 211, 102, 0.35)', flexShrink: 0 }}>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12.012 2c-5.506 0-9.989 4.478-9.99 9.984 0 1.764.459 3.487 1.332 5.003l-1.417 5.176 5.302-1.39a9.943 9.943 0 0 0 4.77 1.215h.004c5.505 0 9.988-4.478 9.989-9.985 0-2.668-1.037-5.176-2.924-7.062a9.923 9.923 0 0 0-7.066-2.945zm.004 18.155h-.003a8.27 8.27 0 0 1-4.218-1.157l-.302-.18-3.136.822.836-3.056-.197-.314a8.27 8.27 0 0 1-1.272-4.436c0-4.568 3.717-8.283 8.286-8.283 2.213 0 4.293.862 5.858 2.428a8.243 8.243 0 0 1 2.427 5.856c0 4.569-3.718 8.284-8.281 8.284z"/></svg>
                </div>
                <span style={{ fontSize: '0.62rem', fontWeight: 700, color: 'var(--text-secondary)', width: '100%', textAlign: 'center', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>WhatsApp</span>
              </button>
              ...
              <button 
                ...
                style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '6px', background: 'transparent', border: 'none', cursor: 'pointer', width: '100%', minWidth: 0, padding: '2px 0', boxSizing: 'border-box' }}
              >
                <div style={{ width: 'clamp(36px, 10vw, 42px)', height: 'clamp(36px, 10vw, 42px)', borderRadius: '14px', background: '#1877F2', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', boxShadow: '0 4px 12px rgba(24, 119, 242, 0.35)', flexShrink: 0 }}>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                </div>
                <span style={{ fontSize: '0.62rem', fontWeight: 700, color: 'var(--text-secondary)', width: '100%', textAlign: 'center', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>Facebook</span>
              </button>
              ...
              <button 
                ...
                style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '6px', background: 'transparent', border: 'none', cursor: 'pointer', width: '100%', minWidth: 0, padding: '2px 0', boxSizing: 'border-box' }}
              >
                <div style={{ width: 'clamp(36px, 10vw, 42px)', height: 'clamp(36px, 10vw, 42px)', borderRadius: '14px', background: '#000000', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', boxShadow: '0 4px 12px rgba(0, 0, 0, 0.3)', border: '1px solid var(--border-color)', flexShrink: 0 }}>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                </div>
                <span style={{ fontSize: '0.62rem', fontWeight: 700, color: 'var(--text-secondary)', width: '100%', textAlign: 'center', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>Twitter / X</span>
              </button>
              ...
              <button 
                ...
                style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '6px', background: 'transparent', border: 'none', cursor: 'pointer', width: '100%', minWidth: 0, padding: '2px 0', boxSizing: 'border-box' }}
              >
                <div style={{ width: 'clamp(36px, 10vw, 42px)', height: 'clamp(36px, 10vw, 42px)', borderRadius: '14px', background: '#229ED9', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', boxShadow: '0 4px 12px rgba(34, 158, 217, 0.35)', flexShrink: 0 }}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.64 6.8c-.15 1.58-.8 5.42-1.13 7.19-.14.75-.42 1-.68 1.03-.58.05-1.02-.38-1.58-.75-.88-.58-1.38-.94-2.23-1.5-.99-.65-.35-1.01.22-1.59.15-.15 2.71-2.48 2.76-2.69a.2.2 0 0 0-.05-.18c-.06-.05-.14-.03-.21-.02-.09.02-1.49.95-4.22 2.79-.4.27-.76.41-1.08.4-.36-.01-1.04-.2-1.55-.37-.63-.2-1.12-.31-1.08-.66.02-.18.27-.36.74-.55 2.92-1.27 4.86-2.11 5.83-2.51 2.78-1.16 3.35-1.36 3.73-1.36.08 0 .27.02.39.12.1.08.13.19.14.27-.01.06.01.24 0 .38z"/></svg>
                </div>
                <span style={{ fontSize: '0.62rem', fontWeight: 700, color: 'var(--text-secondary)', width: '100%', textAlign: 'center', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>Telegram</span>
              </button>
              ...
              <button 
                ...
                style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '6px', background: 'transparent', border: 'none', cursor: 'pointer', width: '100%', minWidth: 0, padding: '2px 0', boxSizing: 'border-box' }}
              >
                <div style={{ width: 'clamp(36px, 10vw, 42px)', height: 'clamp(36px, 10vw, 42px)', borderRadius: '14px', background: 'linear-gradient(45deg, #f09433 0%, #e6683c 25%, #dc2743 50%, #cc2366 75%, #bc1888 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', boxShadow: '0 4px 12px rgba(220, 39, 67, 0.35)', flexShrink: 0 }}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>
                </div>
                <span style={{ fontSize: '0.62rem', fontWeight: 700, color: 'var(--text-secondary)', width: '100%', textAlign: 'center', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>Instagram</span>
              </button>
            </div>

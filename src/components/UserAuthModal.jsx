              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                ...
                <div>
                  ...
                  <div className="auth-input-group">
                    <User size={16} className="auth-input-icon" style={{ color: '#64748B' }} />
                    <input 
                      type="text" 
                      ...
                      required
                      className="auth-input-field neu-input"
                ...
                <div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '6px' }}>
                    <label style={{ fontSize: '0.8rem', fontWeight: '600', color: '#64748B' }}>Password</label>
                  </div>
                  <div className="auth-input-group" style={{ position: 'relative' }}>
                    <Lock size={16} className="auth-input-icon" style={{ color: '#64748B' }} />
                    <input 
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', margin: '2px 0' }}>
                  ...
                  >
                    <div className={`neu-checkbox ${rememberMe ? 'checked' : ''}`}>
                      {rememberMe && <CheckCircle size={14} color="#FFFFFF" />}
                    </div>
                    <span style={{ fontSize: '0.82rem', fontWeight: '600', color: '#64748B' }}>Remember me</span>
                  </div>
                ...
                <div style={{ textAlign: 'center', marginTop: '10px', fontSize: '0.84rem', color: '#64748B' }}>
